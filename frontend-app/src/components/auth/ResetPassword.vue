    ...
    <div class="login-box">
      <div class="card card-outline card-primary">
        <div class="card-header text-center">
          <router-link to="/" class="h1 link-offset-2 link-underline link-underline-opacity-0"><b>Task</b> System</router-link>
        </div>
        <div class="card-body">
          ...
          <p class="mb-1 text-center ">
            <router-link :to="{ name: 'auth.signin' }" class="link-offset-2 link-underline link-underline-opacity-0">Go back to login</router-link>
          </p>
